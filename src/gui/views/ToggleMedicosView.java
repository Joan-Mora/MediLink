...
public class ToggleMedicosView extends JPanel {
    ...
    public ToggleMedicosView(String medicosJson, BiConsumer<List<String>, Boolean> onToggle) {
        ...
        JLabel titleLabel = new JLabel("⚡ ACTIVAR/DESACTIVAR MÉDICOS");

        titleLabel.setFont(new Font("Segoe UI", Font.BOLD, 18));

        titleLabel.setForeground(SUCCESS_GREEN);

        JLabel warningLabel = new JLabel("<html><i>Los médicos desactivados no podrán acceder al sistema pero mantendrán su historial médico</i></html>");
        ...
        String[] medicos = medicosJson.split("},");

        for (String medico : medicos) {

            try {

                String id = extractValue(medico, "id_medico");

                String nombres = extractValue(medico, "nombres");

                String apellidos = extractValue(medico, "apellidos");

                String especialidad = extractValue(medico, "especialidad");

                String activoStr = extractValue(medico, "activo");
                ...
                if (id != null && nombres != null && apellidos != null) {
                    ...
                    JLabel spec = new JLabel("■ " + (especialidad != null ? especialidad : "N/A"));

                    spec.setFont(new Font("Segoe UI", Font.PLAIN, 12));

                    spec.setForeground(Color.GRAY);
        ...
        activar.addActionListener(e -> {
            ...
            if (selected.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "Selecciona al menos un médico para activar", "Sin selección", JOptionPane.WARNING_MESSAGE);
        ...
        desactivar.addActionListener(e -> {
            ...
            if (selected.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(this, "Selecciona al menos un médico para desactivar", "Sin selección", JOptionPane.WARNING_MESSAGE);
            ...
            int confirm = JOptionPane.showConfirmDialog(this,
                    ...
                    "¿Estás seguro de desactivar " + selected.size() + " médico(s)?\nLos médicos desactivados no podrán acceder al sistema.",
